...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item viool $\SI{196}{\hertz}$ tot $\pm\SI{4.5}{\kilo\hertz}$;
    \item gitaar: $\SI{83}{\hertz}$ tot $\SI{\pm 1}{\kilo\hertz}$;
    \item piano: $\SI{27}{\hertz}$ tot $\SI{4.2}{\kilo\hertz}$.
  \end{enumerate}
  \pause
...
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}[h]{cccccccc}
      ...
      $\SI{131}{\hertz}$ & $\SI{147}{\hertz}$ & $\SI{165}{\hertz}$ & $\SI{175}{\hertz}$ & $\SI{196}{\hertz}$ & $\SI{220}{\hertz}$ & $\SI{247}{\hertz}$
    \end{tabular}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item exponentieel stijgend
  \end{enumerate}
  \pause
  \begin{block}{Paradox}
    We kunnen ons gehoor bedotten.
  \end{block}
  \pause
  Toepassing: basfrequenties op een klein membraan.
\end{frame}
